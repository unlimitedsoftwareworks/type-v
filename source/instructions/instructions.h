...
VM_INSTRUCTION(upcast_i)
VM_INSTRUCTION(upcast_u)
VM_INSTRUCTION(upcast_f)

VM_INSTRUCTION(dcast_i)
VM_INSTRUCTION(dcast_u)
VM_INSTRUCTION(dcast_f)
...
VM_INSTRUCTION(reg_ffi)
VM_INSTRUCTION(open_ffi)
